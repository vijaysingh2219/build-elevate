...
- API uses Vitest presets for Node workspaces.

<Callout type="info">
  See [API Application](../applications/api) for app-specific testing commands
  and [Web Application](../applications/web) for browser testing setup.
</Callout>
