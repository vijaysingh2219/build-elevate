    ...
    <main className="m-auto flex items-center justify-center px-4">
      <div className="bg-background/70 flex max-w-2xl flex-col items-center gap-5 rounded-xl p-8 text-center backdrop-blur">
        ...
        <p className="text-muted-foreground max-w-md">
          ...
          Includes authentication, a responsive UI, and a modern development setup.
        </p>
        <div className="mt-4 flex flex-col gap-3 sm:flex-row">
          <Button asChild size="sm">
            <Link href="https://github.com/vijaysingh2219/turborepo-starter" target="_blank">
              View on GitHub
            </Link>
          </Button>
          <Button asChild variant="secondary" size="sm">
            <Link
              href="https://github.com/vijaysingh2219/turborepo-starter?tab=readme-ov-file#readme"
              target="_blank"
            >
              Read Docs
            </Link>
